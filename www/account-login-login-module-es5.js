(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["account-login-login-module"], {
  ...
  function (module, __webpack_exports__, __webpack_require__) {
    ...
    "./node_modules/@ionic-native/facebook/ngx/index.js"); // Facebook
        ...
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
          ...
          this.server.login(data).subscribe(response => {
            if (response.msg != "done") {
              this.presentToast(response.msg); // this.nav.navigateRoot('signup');  
            } else {
